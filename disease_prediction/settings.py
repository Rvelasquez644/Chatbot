...
DATABASES = {
    'default': {
        ...
        'NAME': 'dps',  # Nombre de la base de datos
        'USER': 'postgres',  # Nombre de usuario de la base de datos
        'PASSWORD': '12345',  # Contraseña del usuario de la base de datos
        'HOST': 'localhost',  # Host de la base de datos (puede ser una IP o un dominio)
        'PORT': '5432',  # Puerto de la base de datos (dejar en blanco si es el puerto default)
    }
}
